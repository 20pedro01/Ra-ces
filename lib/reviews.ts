...
export const INITIAL_REVIEWS: Review[] = [
  // --- Paquete: Ruta de las Abejas Meliponas ---
  {
    ...
    rating: 5,
    comment: 'Una experiencia transformadora. Probar la miel sagrada directamente de los jobones con Don Anastasio fue algo mágico. El respeto con el que cuidan a las abejas y la calidez de la comunidad nos conmovió profundamente.',
  ...
  // --- Paquete: Cenotes y Leyendas ---
  {
    ...
    rating: 5,
    comment: 'Nadar en un cenote casi privado mientras Don Manuel nos contaba las historias de los aluxes fue inolvidable. La comida de las cocineras tradicionales estuvo exquisita.',
  ...
  // --- Paquete: Sabores de Yucatán ---
  {
    ...
    rating: 5,
    comment: 'Hacer cochinita pibil en horno de tierra bajo la supervisión de Doña Betty fue un honor. El recado rojo hecho a mano en metate no tiene comparación con nada comercial.',
  ...
  // --- Experiencia / Taller: Taller de Hamacas ---
  {
    ...
    rating: 5,
    comment: 'Doña Socorro tiene una paciencia infinita. Uno no se imagina la cantidad de horas y destreza que lleva urdir una hamaca hasta que se sienta frente al bastidor. Un tesoro vivo.',
  ...
  // --- Experiencia / Taller: Cocina Tradicional ---
  {
    ...
    rating: 5,
    comment: 'La comida más rica de todo nuestro viaje a México. Doña María nos recibió en su cocina de leña con un amor inmenso. El poc chuc y los frijoles con puerco estaban gloriosos.',
